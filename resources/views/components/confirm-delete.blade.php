            ...
            <el-dialog-panel
                ...
                <div class="mt-5 sm:mt-4 sm:flex justify-end gap-3">
                    ...
                    <button type="button" command="close" commandfor={{ $id }}
                        class="mt-3 inline-flex w-full justify-center rounded-md bg-white px-3 py-2 text-sm font-semibold text-gray-900 shadow-xs inset-ring-1 inset-ring-gray-300 hover:bg-gray-50 sm:mt-0 sm:w-auto dark:bg-white/10 dark:text-white dark:shadow-none dark:inset-ring-white/5 dark:hover:bg-white/20">Cancelar</button>
                    ...
                    <form method="POST" action="{{ $action }}">
                        ...
                        <button type="submit" command="close" commandfor="dialog"
                            class="inline-flex w-full justify-center rounded-md bg-red-600 px-3 py-2 text-sm font-semibold text-white shadow-xs hover:bg-red-500 sm:ml-3 sm:w-auto dark:bg-red-500 dark:shadow-none dark:hover:bg-red-400">Eliminar</button>
                    </form>
                </div>
            </el-dialog-panel>
        </div>
